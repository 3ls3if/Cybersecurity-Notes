...
* **What is a Fallacy?**\
  A fallacy is an error in reasoning that weakens an argument. It can be unintentional or used intentionally to deceive.<br>
* **Types of Fallacies:**
  *   **Formal Fallacies:** These are errors in the logical structure of an argument. Even if the premises are true, the conclusion does not logically follow.<br>
  ...
  * **Informal Fallacies:** These are errors in reasoning due to the content or context of the argument.
    * **Example:** Burden of proof – Claiming something is true just because it hasn't been proven false.<br>
* **Common Examples:**
  ...
  * **Argument by Repetition (Informal):** Repeating an argument without providing new evidence.
    * **Example:** "This is wrong." "No, it isn't." "Yes, it is." (repeatedly without new support)<br>
